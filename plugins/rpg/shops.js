...
`.trim()
    try {
        if (/shop|toko/i.test(command)) {
            ...
            const trash = db.data.users[m.sender].trash
            switch (jualbeli) {
            case 'buy':
                switch (_type) {
                    case 'limit':
                            if (db.data.users[m.sender].eris >= Blimit * count) {
                                db.data.users[m.sender].eris -= Blimit * count
                  ...
                  case 'iron':
                        ...
                        break
                  case 'string':
                            if (db.data.users[m.sender].eris >= Bstring * count) {
                                db.data.users[m.sender].string += count * 1
                                db.data.users[m.sender].eris -= Bstring * count
                        ...
                        break
                  case 'sword':
                            if (db.data.users[m.sender].eris >= Bsword * count) {
                                db.data.users[m.sender].sword += count * 1
                                db.data.users[m.sender].eris -= Bsword * count
                        ...
                        break 
                  case 'rock':
                            if (db.data.users[m.sender].eris >= Brock * count) {
                                db.data.users[m.sender].rock += count * 1
                                db.data.users[m.sender].eris -= Brock * count
                        ...
                        break 
                    case 'umpan':
                            if (db.data.users[m.sender].eris >= Bumpan * count) {
                                db.data.users[m.sender].umpan += count * 1
                                db.data.users[m.sender].eris -= Bumpan * count
                        ...
                        break 
                    case 'pancingan':
                            if (db.data.users[m.sender].eris >= Bpancingan * count) {
                                db.data.users[m.sender].pancingan += count * 1
                                db.data.users[m.sender].eris -= Bpancingan * count
                    ...
                    case 'armor':
                            ...
                            if (db.data.users[m.sender].eris > armor) {
                                db.data.users[m.sender].armor += 1
                                db.data.users[m.sender].eris -= armor * 1
                ...
                switch (_type) {
                    case 'potion':
                        if (db.data.users[m.sender].potion >= count * 1) {
                            db.data.users[m.sender].eris += Spotion * count
                            db.data.users[m.sender].potion -= count * 1
                    ...
                    case 'common':
                        if (db.data.users[m.sender].common >= count * 1) {
                            db.data.users[m.sender].eris += Scommon * count
                            db.data.users[m.sender].common -= count * 1
                    ...
                    case 'uncommon':
                        if (db.data.users[m.sender].uncommon >= count * 1) {
                            db.data.users[m.sender].eris += Suncommon * count
                            db.data.users[m.sender].uncommon -= count * 1
                    ...
                    case 'mythic':
                        if (db.data.users[m.sender].mythic >= count * 1) {
                            db.data.users[m.sender].eris += Smythic * count
                            db.data.users[m.sender].mythic -= count * 1
                    ...
                    case 'legendary':
                        if (db.data.users[m.sender].legendary >= count * 1) {
                            db.data.users[m.sender].eris += Slegendary * count
                            db.data.users[m.sender].legendary -= count * 1
                        ...
                        break
                    case 'trash':
                        if (db.data.users[m.sender].trash >= count * 1) {
                            db.data.users[m.sender].trash -= count * 1
                            db.data.users[m.sender].eris += Strash * count
                        ...
                        break
                    case 'wood':
                        if (db.data.users[m.sender].wood >= count * 1) {
                            db.data.users[m.sender].wood -= count * 1
                            db.data.users[m.sender].eris += Swood * count
                    ...
                    case 'pancingan':
                        if (db.data.users[m.sender].pancingan >= count * 1) {
                            db.data.users[m.sender].pancingan -= count * 1
                            db.data.users[m.sender].eris += Spancingan * count
                    ...
                    case 'iron':
                        if (db.data.users[m.sender].iron >= count * 1) {
                            db.data.users[m.sender].iron -= count * 1
                            db.data.users[m.sender].eris += Siron * count
                    ...
                    case 'string':
                        if (db.data.users[m.sender].string >= count * 1) {
                            db.data.users[m.sender].string -= count * 1
                            db.data.users[m.sender].eris += Sstring * count
                    ...
                    case 'sword':
                        if (db.data.users[m.sender].sword >= count * 1) {
                            db.data.users[m.sender].sword -= count * 1
                            db.data.users[m.sender].eris += Ssword * count
                        ...
                        break
                    case 'rock':
                        if (db.data.users[m.sender].rock >= count * 1) {
                            db.data.users[m.sender].rock -= count * 1
                            db.data.users[m.sender].eris += Srock * count
                    ...
                    case 'diamond':
                        if (db.data.users[m.sender].diamond >= count * 1) {
                            db.data.users[m.sender].diamond -= count * 1
                            db.data.users[m.sender].eris += Sdiamond * count
            ...
            switch (type) {
                ...
                case 'armor':
                        if (db.data.users[m.sender].armor == 5) return conn.reply(m.chat, 'Armormu sudah *Level Max*', m)
                        if (db.data.users[m.sender].eris > armor * 1) {
                            db.data.users[m.sender].armor += 1
                            db.data.users[m.sender].eris -= armor * 1
                            conn.reply(m.chat, `Succes membeli armor seharga ${armor} eris` ,m)
