...
let handler = async (m, { conn, args, usedPrefix, DevMode }) => {
    if (args.length < 3) {
        ...
        switch (type) {
            case 'eris':
                if (db.data.users[m.sender].eris >= count * 1) {
                    try {
                        db.data.users[m.sender].eris -= count * 1
                        db.data.users[who].eris += count * 1
            ...
            case 'trash':
                if (db.data.users[m.sender].trash >= count * 1) {
                    try {
                        ...
                        db.data.users[who].trash += count * 1
            ...
            case 'rock':
                if (db.data.users[m.sender].rock >= count * 1) {
                    try {
                        ...
                        db.data.users[who].rock += count * 1
            ...
            case 'wood':
                if (db.data.users[m.sender].wood >= count * 1) {
                    try {
                        ...
                        db.data.users[who].wood += count * 1
